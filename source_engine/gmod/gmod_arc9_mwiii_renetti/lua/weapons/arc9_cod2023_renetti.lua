...
SWEP.Base = "arc9_cod2019_base_renetti"
...
SWEP.Credits = {
    ...
    Assets = "Sledgehammer Games/Infinity Ward/Valve/New World Interactive"
}

SWEP.Description = [[A burst-fire pistol with a staggering fire rate and controllability in the right hands.]]

SWEP.ViewModel = "models/weapons/cod2023/c_pist_renetti.mdl"
SWEP.WorldModel = "models/weapons/cod2023/c_pist_renetti.mdl"

SWEP.Slot = 1

SWEP.MirrorVMWM = true
SWEP.NoTPIKVMPos = false
SWEP.WorldModelMirror = "models/weapons/cod2023/c_pist_renetti.mdl"
...
SWEP.ShellModel = "models/weapons/cod2022/casing/casing_9p.mdl"
...
SWEP.DropMagazineModel = "models/weapons/cod2023/mags/w_pist_mike93_mag_15.mdl" -- Set to a string or table to drop this magazine when reloading.
...
local path = "weapons/cod2023/renetti/"

SWEP.ShootSound = "COD2023.Renetti.Fire."
SWEP.ShootSoundIndoor = "COD2023.Renetti.Fire"

SWEP.ShootSoundSilenced = "COD2023.Renetti.Fire.S"
SWEP.ShootSoundSilencedIndoor = "COD2023.Renetti.Fire.S"
...
SWEP.TriggerDownSound = "weapons/cod2023/renetti/weap_mike9a3_hammer_plr_01.ogg"
SWEP.TriggerUpSound = "weapons/cod2023/renetti/weap_mike9a3_disconnector_plr_01.ogg"
...
SWEP.Animations = {
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
			{s = path .. "p12_pi_mike93_reload_raise.ogg", t = 0/30},
			{s = path .. "p12_pi_mike93_reload_empty_magout.ogg", t = 8/30},
			{s = path .. "p12_pi_mike93_reload_empty_grab.ogg", t = 20/30},
			{s = path .. "p12_pi_mike93_reload_empty_maghit.ogg", t = 22/30},
			{s = path .. "p12_pi_mike93_reload_empty_magin.ogg", t = 25/30},
    ...
    ["ready"] = {
        ...
        EventTable = {
            {s = path .. "p12_pi_mike93_raise_first_up.ogg", t = 1/30},
            {s = path .. "p12_pi_mike93_raise_first_charge.ogg", t = 16/30},
			{s = path .. "p12_pi_mike93_raise_first_end.ogg", t = 20/30},
        },
    },
    ["draw"] = {
        Source = "draw_short",
        EventTable = {
            {s = path .. "p12_pi_mike93_raise_first_up.ogg", t = 0/30},
        },
    },
    ["holster"] = {
        Source = "holster",
        EventTable = {
            {s = path .. "p12_pi_mike93_drop.ogg", t = 0/30},
        },
    },
    ["idle"] = {
        Source = "idle",
    ...
    ["inspect"] = {
        ...
        EventTable = {
			...
			{s = path .. "p12_pi_mike93_inspect_magout.ogg", t = 12/30},
			{s = path .. "p12_pi_mike93_inspect_maghit.ogg", t = 49/30},
			{s = path .. "p12_pi_mike93_inspect_magin.ogg", t = 53/30},
...
SWEP.AttachmentTableOverrides = {
    ...
    ActivePos = Vector(3.5, 0, 1.5),
    ActiveAng = Angle(0, 0, 20),

    MovingPos = Vector(2, 0, 0.5),
...
SWEP.Attachments = {
    {
        ...
        Category = "cod2023_renetti_barrel",
    ...
    },
    {
		...
		Scale = 1,
		InstalledElements = {"barrel_mount"},
    },
    {
        PrintName = "Laser",
    ...
    },
    {
        ...
        Category = "cod2023_renetti_pgrip",
        Bone = "tag_pistolgrip_attach",
        Pos = Vector(0, 0, 0),
        Ang = Angle(0, 0, 0),
    },
    {
        PrintName = "Trigger Action",
        DefaultAttName = "Standard trigger",
        Category = "cod2023_renetti_trigger",
        Bone = "tag_trigger_attach",
        Pos = Vector(0, 0, 0),
        Ang = Angle(0, 0, 0),
    },
    {
