...
ATTACHMENT.Name = "Renetti Receiver, Fiammata Trigger"
ATTACHMENT.Model = Model("models/zaihny/mw23/attachments/mike93/attachment_vm_jup_pi_mike93_rec_trigger_hair_000.mdl")
ATTACHMENT.Icon = Material("zaihny/mw23/attachments/icons/mike93/icon_attachment_vm_jup_pi_mike93_rec_trigger_hair_000.vmt")
...
function ATTACHMENT:Stats(weapon)
    ...
    weapon.Primary.RPM = weapon.Primary.RPM * 1.20 
