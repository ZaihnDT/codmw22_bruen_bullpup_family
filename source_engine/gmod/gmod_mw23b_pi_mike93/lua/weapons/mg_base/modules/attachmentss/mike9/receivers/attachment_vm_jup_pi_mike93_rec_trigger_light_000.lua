...
ATTACHMENT.Name = "Renetti Receiver, Bruen MG89 Trigger"
ATTACHMENT.Model = Model("models/zaihny/mw23/attachments/mike93/attachment_vm_jup_pi_mike93_rec_trigger_light_000.mdl")
ATTACHMENT.Icon = Material("zaihny/mw23/attachments/icons/mike93/icon_attachment_vm_jup_pi_mike93_rec_trigger_light_000.vmt")
...
function ATTACHMENT:Stats(weapon)
    ...
    weapon.Primary.RPM = weapon.Primary.RPM * 1.15 
