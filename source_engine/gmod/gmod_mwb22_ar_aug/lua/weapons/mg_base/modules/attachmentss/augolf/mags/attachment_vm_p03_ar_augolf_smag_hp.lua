...
ATTACHMENT.Name = "Single Tap Mod Hollow Point"
ATTACHMENT.Model = Model("models/zaihny/mw22/attachments/augolf/attachment_vm_p03_ar_augolf_smag_hp.mdl")
ATTACHMENT.Icon = Material("zaihny/mw22/attachments/icons/augolf/icon_attachment_vm_p03_ar_augolf_smag_hp.vmt")
...
function ATTACHMENT:Stats(weapon)
    ...
    weapon.Shell = "mw2_eject_556n_hp"
    ...
    weapon.Bullet.Damage[1] = weapon.Bullet.Damage[1] * 1.65
    weapon.Bullet.Damage[2] = weapon.Bullet.Damage[2] * 1.65
     weapon.Bullet.DropOffStartRange = weapon.Bullet.DropOffStartRange * 1.9
    weapon.Bullet.EffectiveRange = weapon.Bullet.EffectiveRange *  1.9
    weapon.Bullet.Range = weapon.Bullet.Range * 2
    weapon.Bullet.Penetration.Thickness = weapon.Bullet.Penetration.Thickness * 1.75
