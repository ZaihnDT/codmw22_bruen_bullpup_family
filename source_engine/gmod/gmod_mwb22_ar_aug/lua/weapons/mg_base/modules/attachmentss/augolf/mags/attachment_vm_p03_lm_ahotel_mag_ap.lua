...
ATTACHMENT.Name = "60 Round Mag Armor Piercing"
ATTACHMENT.Model = Model("models/zaihny/mw22/attachments/augolf/attachment_vm_p03_lm_ahotel_mag_ap.mdl")
ATTACHMENT.Icon = Material("zaihny/mw22/attachments/icons/augolf/icon_attachment_vm_p03_lm_ahotel_mag_ap.vmt")
...
function ATTACHMENT:Stats(weapon)
    ...
    weapon.Bullet.Penetration.Thickness = weapon.Bullet.Penetration.Thickness * 2.05
