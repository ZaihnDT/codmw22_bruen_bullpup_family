...
ATTACHMENT.Name = "MX9"
ATTACHMENT.Icon = Material("zaihny/mw22/attachments/icons/augolf/icon_attachment_vm_p03_sm_apapa_receiver.vmt")
...
function ATTACHMENT:PostProcess(weapon)
    ...
    weapon:SetWorldModel("models/zaihny/mw22/weapons/w_apapa.mdl")
    weapon:SetViewModel("models/zaihny/mw22/weapons/v_apapa.mdl")
