...
ATTACHMENT.Name = "HCR 56"
ATTACHMENT.Icon = Material("zaihny/mw22/attachments/icons/augolf/icon_attachment_vm_p03_lm_ahotel_receiver.vmt")
...
function ATTACHMENT:PostProcess(weapon)
    ...
    weapon:SetWorldModel("models/zaihny/mw22/weapons/w_ahotel.mdl")
    weapon:SetViewModel("models/zaihny/mw22/weapons/v_ahotel.mdl")
