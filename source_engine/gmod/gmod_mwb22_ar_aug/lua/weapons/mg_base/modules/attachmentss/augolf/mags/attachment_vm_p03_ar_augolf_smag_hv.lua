...
ATTACHMENT.Name = "Single Tap Mod High Velocity"
ATTACHMENT.Model = Model("models/zaihny/mw22/attachments/augolf/attachment_vm_p03_ar_augolf_smag_hv.mdl")
ATTACHMENT.Icon = Material("zaihny/mw22/attachments/icons/augolf/icon_attachment_vm_p03_ar_augolf_smag_hv.vmt")
...
function ATTACHMENT:Stats(weapon)
    ...
    weapon.Bullet.Damage[2] = weapon.Bullet.Damage[2] * 1.4
     weapon.Bullet.DropOffStartRange = weapon.Bullet.DropOffStartRange * 2.1
    weapon.Bullet.EffectiveRange = weapon.Bullet.EffectiveRange * 2.1
    weapon.Bullet.Range = weapon.Bullet.Range * 2.1
