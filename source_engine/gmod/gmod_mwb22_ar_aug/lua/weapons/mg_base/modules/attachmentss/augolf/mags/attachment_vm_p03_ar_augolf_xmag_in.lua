...
ATTACHMENT.Name = "42 Round Mag Incendiary"
ATTACHMENT.Model = Model("models/zaihny/mw22/attachments/augolf/attachment_vm_p03_ar_augolf_xmag_in.mdl")
ATTACHMENT.Icon = Material("zaihny/mw22/attachments/icons/augolf/icon_attachment_vm_p03_ar_augolf_xmag_in.vmt")
ATTACHMENT.ExcludedAttachments = {"att_perk_rof", "att_perk_fmj"}
ATTACHMENT.ExcludedCategories = {"Magazines"}
...
weapon.doDBStats = function(weapon) end
    BaseClass.Stats(self, weapon)
    weapon:doCalConversionStats()
    weapon.Shell = "mw2_eject_556n_in"
