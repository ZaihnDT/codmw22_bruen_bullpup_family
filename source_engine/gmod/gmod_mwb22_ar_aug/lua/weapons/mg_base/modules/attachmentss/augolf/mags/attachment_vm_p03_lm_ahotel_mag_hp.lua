...
ATTACHMENT.Name = "60 Round Mag Hollow Point"
ATTACHMENT.Model = Model("models/zaihny/mw22/attachments/augolf/attachment_vm_p03_lm_ahotel_mag_hp.mdl")
ATTACHMENT.Icon = Material("zaihny/mw22/attachments/icons/augolf/icon_attachment_vm_p03_lm_ahotel_mag_hp.vmt")
ATTACHMENT.ExcludedAttachments = {"att_perk_rof", "att_perk_fmj"}
ATTACHMENT.ExcludedByAttachments = {"att_receiver", "attachment_vm_p03_ar_augolf_receiver", "attachment_vm_p03_sm_apapa_receiver"}
...
function ATTACHMENT:Stats(weapon)
    ...
    weapon.Bullet.Damage[1] = weapon.Bullet.Damage[1] * 1.295
    weapon.Bullet.Damage[2] = weapon.Bullet.Damage[2] * 1.295
