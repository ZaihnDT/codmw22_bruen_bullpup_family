...
ATTACHMENT.Name = "Single Tap Mod Armor Piercing"
ATTACHMENT.Model = Model("models/zaihny/mw22/attachments/augolf/attachment_vm_p03_ar_augolf_smag_ap.mdl")
ATTACHMENT.Icon = Material("zaihny/mw22/attachments/icons/augolf/icon_attachment_vm_p03_ar_augolf_smag_ap.vmt")
...
function ATTACHMENT:Stats(weapon)
    ...
    weapon.Bullet.Damage[1] = weapon.Bullet.Damage[1] * 1.6
    weapon.Bullet.Damage[2] = weapon.Bullet.Damage[2] * 1.6
    ...
    weapon.Bullet.Range = weapon.Bullet.Range * 2.05
