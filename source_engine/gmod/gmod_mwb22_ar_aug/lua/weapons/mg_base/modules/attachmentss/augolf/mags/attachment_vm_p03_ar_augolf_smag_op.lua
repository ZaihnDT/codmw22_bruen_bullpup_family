...
ATTACHMENT.Name = "Single Tap Mod Overpressured"
ATTACHMENT.Model = Model("models/zaihny/mw22/attachments/augolf/attachment_vm_p03_ar_augolf_smag_op.mdl")
ATTACHMENT.Icon = Material("zaihny/mw22/attachments/icons/augolf/icon_attachment_vm_p03_ar_augolf_smag_op.vmt")
...
function ATTACHMENT:Stats(weapon)
    ...
    weapon.Shell = "mw2_eject_556n_op"
    ...
    weapon.Bullet.Damage[1] = weapon.Bullet.Damage[1] * 1.55
    weapon.Bullet.Damage[2] = weapon.Bullet.Damage[2] * 1.55
     weapon.Bullet.DropOffStartRange = weapon.Bullet.DropOffStartRange * 2
